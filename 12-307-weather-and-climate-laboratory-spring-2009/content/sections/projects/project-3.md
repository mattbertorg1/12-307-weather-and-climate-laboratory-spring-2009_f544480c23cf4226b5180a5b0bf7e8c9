...
type: course
uid: 3a1ab119ff1612d94739be22a5e1ed81
...
Project Description ([PDF]({{< baseurl >}}/sections/projects/project3))

Notes on relevant theory:

Convection of an incompressible fluid ([PDF]({{< baseurl >}}/sections/projects/convection_n_air))

Convection in a compressible atmosphere ([PDF]({{< baseurl >}}/sections/projects/convecton_n_watr))
...
A description of the [Convection Experiment](http://paoc.mit.edu/labguide/convect.html) can be found at the Weather in a Tank Web site
