...
type: course
uid: 6e3412d89eb974a9830a26714d44d10d
...
Project Description ([PDF]({{< baseurl >}}/sections/projects/project2))

Notes on relevant theory: thermal wind ([PDF]({{< baseurl >}}/sections/projects/thermal_wind))

Tank Experiments
----------------

You can read about the experiment in the Weather in a Tank project: [Fronts: An Introduction](http://paoc.mit.edu/labguide/fronts.html)

Atmospheric Data
----------------

Relevant Notes at the Weather in a Tank Web site: [The Polar Front](http://paoc.mit.edu/labguide/fronts_polar.html) and [Synoptic-scale Fronts](http://paoc.mit.edu/labguide/fronts_synoptic.html)
